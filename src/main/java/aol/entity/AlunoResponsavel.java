...
public class AlunoResponsavel implements Serializable {
   ...
   * @generated
   */
  public AlunoResponsavel setId(java.lang.String id){
    this.id = id;
    return this;
  }
   ...
   * @generated
   */
  public AlunoResponsavel setAluno(Aluno aluno){
    this.aluno = aluno;
    return this;
  }
   ...
   * @generated
   */
  public AlunoResponsavel setResponsavel(Responsavel responsavel){
