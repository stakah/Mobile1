...
/**
 * Created by sergiot on 22/11/16.
 */
...
@Controller
@RequestMapping("/api/rest/alunos/application.wadl")
public class WADLControllerV2 {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WADLControllerV2.class);
    ...
    public @ResponseBody Application generateWadl(HttpServletRequest request) {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handletMethods.entrySet()) {
            ...
            LOGGER.info("httpMethods.size: " + httpMethods.size());

            for (RequestMethod httpMethod : httpMethods) {
                org.jvnet.ws.wadl.Method wadlMethod = new org.jvnet.ws.wadl.Method();

                LOGGER.info("RequestMethod: " + httpMethod.name());
