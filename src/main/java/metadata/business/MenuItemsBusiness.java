...
/**
 * Classe que representa a camada de negócios de MenuItems
 * @generated
 **/
public class MenuItemsBusiness {
   ...
   */
  public MenuItemsBusiness(final SessionManager sessionmanager) {
    // begin-user-code
    // end-user-code
    this.sessionManager = sessionmanager;
    this.dao = new MenuItemsDAO(sessionmanager.getEntityManager());
    // begin-user-code
    // end-user-code
  }
   ...
   * @generated modifiable   
   */
  public void save(final MenuItems entity) {
    // begin-user-code
    // end-user-code  
    dao.save(entity);
    // begin-user-code
   ...
   * @generated modifiable
   */
  public void refresh(final MenuItems entity) {
    // begin-user-code
    // end-user-code  
    dao.refresh(entity);
    // begin-user-code
   ...
   * @generated modifiable   
   */
  public MenuItems update(final MenuItems entity) {
    // begin-user-code
    // end-user-code  
	MenuItems updatedEntity = dao.update(entity);
    // begin-user-code
    // end-user-code	
   ...
   * @generated modifiable   
   */
  public void delete(final MenuItems entity){
    // begin-user-code
    // end-user-code    
	dao.delete(entity);
    // begin-user-code
  ...
  public MenuItems findById(java.lang.String id){
    // begin-user-code
    // end-user-code  
    MenuItems entity = dao.findById(id);
    // begin-user-code
    // end-user-code      
    return entity;  
  }   
  
  public List<MenuItems> listByMenuId(java.lang.String id, int limit, int offset) {
    List<MenuItems> list = dao.listMenuItems(id, limit, offset);
    return list;
  }
