...
public class SubmenuItems implements Serializable {
   ...
   * @generated
   */
  public SubmenuItems setId(java.lang.String id){
    this.id = id;
    return this;
  }
   ...
   * @generated
   */
  public SubmenuItems setMenuItemParent(MenuItem menuItemParent){
   ...
   * @generated
   */
  public SubmenuItems setMenuItemChild(MenuItem menuItemChild){
