...
* [CB-8904](https://issues.apache.org/jira/browse/CB-8904): Don't reset the www variable when it's destroyed, otherwise we might as well just have a member variable
