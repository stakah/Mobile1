...
**(1)** Get UI-Router in one of the following ways:
 ...
 - or via **[npm](https://static.npmjs.org/)**: by running `$ npm install angular-ui-router` from your console
...
* [Tim Kindberg on Angular UI-Router](https://static.youtube.com/watch?v=lBqiZSemrqg)
